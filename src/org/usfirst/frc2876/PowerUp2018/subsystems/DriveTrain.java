...
public class DriveTrain extends Subsystem {
    ...
    public void updateSmartDashboard() {
		...
		SmartDashboard.putNumber("Encoder Right(1)", rightTalonSRX1.getSelectedSensorPosition(1));
//		SmartDashboard.putNumber("Encoder Right(2)", rightTalonSRX2.getSelectedSensorPosition(2));
		SmartDashboard.putNumber("Encoder Left(3)", leftTalonSRX3.getSelectedSensorPosition(2));
//		SmartDashboard.putNumber("Encoder Left(4)", leftTalonSRX4.getSelectedSensorPosition(4));
