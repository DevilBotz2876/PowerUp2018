...
public class DriveTrain extends Subsystem {
	...
	private RobotConfig rcfg = new PracticeBotConfig();
//	private RobotConfig rcfg = new CompBotConfig();
	
	private final double MAX_RPM = rcfg.getMaxRpm(); // 3127.0f;
	private final double kTurnToleranceDegrees = rcfg.getKTurnToleranceDegrees(); // 1.0f;
	...
	public DriveTrain() {
		...
		leftMaster.setSensorPhase(rcfg.getLeftSensorPhase());  //false
		rightMaster.setSensorPhase(rcfg.getRightSensorPhase());  // true

		//		rightMaster.setInverted(true);
		leftMaster.setInverted(rcfg.getLeftInverted());  // true
		leftFollower.setInverted(rcfg.getLeftInverted());  // true

		leftMaster.config_kP(0, rcfg.getLeftKP(), 0);  // 0.3729
		leftMaster.config_kF(0, rcfg.getLeftKF(), 0);  // 0.3761
		rightMaster.config_kP(0, rcfg.getRightKP(), 0);  // 0.3639
		rightMaster.config_kF(0, rcfg.getRightKF(), 0);  // 0.3503
		...
		distanceController = new PIDController(
				rcfg.getDistancePidP(), rcfg.getDistancePidI(),
				rcfg.getDistancePidI(), rcfg.getDistancePidF(), new AvgEncoder(), new PIDOutput() {
		...
		turnController = new PIDController(
				rcfg.getTurnPidP(), rcfg.getTurnPidI(),
				rcfg.getTurnPidD(), rcfg.getTurnPidF(), navx, new PIDOutput() {
			public void pidWrite(double output) {
	...
	public void arcadeDrive(double xSpeed, double zRotation){
		...
		//differentialDrive.arcadeDrive(adjustSpeed(xSpeed), adjustRotate(zRotation)); 
	...
	public double getDistance(){
		...
		double av = (-r + l) / 2;  //Right side encoder is negative going forward
